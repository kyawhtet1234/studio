    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className={cn("flex h-full w-full flex-col", variant === "floating" && "rounded-xl shadow-lg")}
          >
            {children}
          </div>
        </div>
